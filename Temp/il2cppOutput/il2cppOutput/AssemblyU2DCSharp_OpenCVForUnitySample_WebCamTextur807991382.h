...
struct  ThreadComm_t807991382  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_shouldDetectInMultiThread_0() { return static_cast<int32_t>(offsetof(ThreadComm_t807991382, ___shouldDetectInMultiThread_0)); }
